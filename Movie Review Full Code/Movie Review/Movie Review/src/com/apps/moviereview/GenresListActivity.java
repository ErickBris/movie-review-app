...
import com.example.adapter.GenresList_Adapter;
...
public class GenresListActivity extends ActionBarActivity {

	ListView lsv_cat;
	List<Item_ActorList> arrayOfmovieList;
	GenresList_Adapter objAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		toolbar.setTitle(Constant.GENRESCAT_NAMEE);
		...
		if (JsonUtils.isNetworkAvailable(GenresListActivity.this)) {
			new MyTask().execute(Constant.GENRESLIST_URL+Constant.GENRESCAT_IDD);
		} else {
			showToast("No Network Connection!!!");
			alert.showAlertDialog(GenresListActivity.this, "Internet Connection Error",
	...
	private	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(GenresListActivity.this);
		...
		protected void onPostExecute(String result) {
			...
			if (null == result || result.length() == 0) {
				...
				alert.showAlertDialog(GenresListActivity.this, "Server Connection Error",
	...
	public void setAdapterToListview() {
		objAdapter = new GenresList_Adapter(GenresListActivity.this, R.layout.item_movielist,
				arrayOfmovieList);
	...
	public void showToast(String msg) {
		Toast.makeText(GenresListActivity.this, msg, Toast.LENGTH_LONG).show();
	}
