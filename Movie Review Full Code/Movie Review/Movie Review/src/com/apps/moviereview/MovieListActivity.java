...
import com.example.adapter.MovieList_Adapter;
...
public class MovieListActivity extends ActionBarActivity {
	...
	ListView lsv_cat;
	List<Item_MovieList> arrayOfmovieList;
	MovieList_Adapter objAdapter;
	AlertDialogManager alert = new AlertDialogManager();
	private Item_MovieList objAllBean;
	JsonUtils util;
	int textlength = 0;
	Toolbar toolbar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrayOfmovieList=new ArrayList<Item_MovieList>();


		util=new JsonUtils(getApplicationContext());

		if (JsonUtils.isNetworkAvailable(MovieListActivity.this)) {
			new MyTask().execute(Constant.MOVIELIST_URL+Constant.CATEGORY_IDD);
		} else {
			showToast("No Network Connection!!!");
			alert.showAlertDialog(MovieListActivity.this, "Internet Connection Error",
	...
	private	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (null == result || result.length() == 0) {
				...
				alert.showAlertDialog(MovieListActivity.this, "Server Connection Error",
	...
	public void setAdapterToListview() {
		objAdapter = new MovieList_Adapter(MovieListActivity.this, R.layout.item_movielist,
				arrayOfmovieList);
	...
	public void showToast(String msg) {
		Toast.makeText(MovieListActivity.this, msg, Toast.LENGTH_LONG).show();
	}
